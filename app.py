    ...
    if archivo_audio is not None:
        ...
        if st.button(
            ...
            if resultado.empty:
                ...
                st.success(
                    "¡Encontré estas canciones similares!"
                )
                ...
                msg = (
                    f"🎵 Busqué por audio y "
                    f"la canción más similar es "
                    f"**{top1['Título']}** de "
                    f"**{top1['Artista']}** "
                    f"(similitud: "
                    f"{top1['Similitud']})"
...
if prompt := st.chat_input(
    "Escribe un artista o una letra..."
):
    ...
    with st.chat_message("assistant"):
        ...
        if os.path.exists(CSV_PATH):
            ...
            if (
                st.session_state.pending_artist
                and
                prompt.lower() in [
                    "si",
                    "sí",
